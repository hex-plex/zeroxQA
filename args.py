...
def get_train_test_args():
    ...
    parser.add_argument('--batch-size', type=int, default=24) # default 16
    ...
    parser.add_argument('--train-dir', type=str, default='datasets/devrev_data')
    parser.add_argument('--val-dir', type=str, default='datasets/meta_val')
